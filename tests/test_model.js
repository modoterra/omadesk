...
test("70 layout apply uses Super+L workspace ids and does not pin a second rule", function() {
  ...
  assert.strictEqual(first[7], "3, layout:scrolling")
  assert.strictEqual(second[7], "3, layout:dwindle")
  assert.notStrictEqual(first[5], second[5])
  assert.notStrictEqual(first[7], second[7])
  ...
  assert.strictEqual(lotArgv[7], "-83, layout:scrolling")
